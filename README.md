...
which is complete with three modes: forward, backward or both. The selection procedure it uses is based on the
Akaike Information Criterion (AIC), as we intend ours to be.
